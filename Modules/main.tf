...
# Calling security-group module to create a security group named "eSparkBiz-secgrp-1"
module "security_grp1" {
  source = ".//security-grp"

  security_group_name = "eSparkBiz-secgrp-1"
...
# Calling security-group module to create a security group named "eSparkBiz-secgrp-2"
module "security_grp2" {
  source = ".//security-grp"

  security_group_name = "eSparkBiz-secgrp-2"
